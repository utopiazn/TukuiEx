...
if not C["unitframes"].enable == true or C["raidframes"].gridonly == true then return end
...
oUF:Factory(function(self)
	...
	"showParty", true, "showPlayer", C["raidframes"].showplayerinparty, "showRaid", true, "groupFilter", "1,2,3,4,5,6,7,8", "groupingOrder", "1,2,3,4,5,6,7,8", "groupBy", "GROUP", "yOffset", T.Scale(-4))
