if GetLocale() == "koKR" then
	...
	TukuiL.option_media_font = "기본 글꼴"
	TukuiL.option_media_uffont = "개체창 글꼴"
	TukuiL.option_media_dmgfont = "전투 메시지 글꼴"
	TukuiL.option_media_npfont = "이름표 글꼴"
	TukuiL.option_media_pixelfont = "픽셀 글꼴"
	TukuiL.option_media_normTex = "바 텍스쳐"
	TukuiL.option_media_glowTex = "그림자 텍스쳐"
	TukuiL.option_media_bubbleTex = "연계점수 텍스쳐"
	TukuiL.option_media_copyicon = "복사 아이콘"
	TukuiL.option_media_configicon = "설정 아이콘"
	TukuiL.option_media_blank = "기본 텍스쳐"
	TukuiL.option_media_bordercolor = "기본 선 색상"
	TukuiL.option_media_altbordercolor = "개체창 선 색상"
	TukuiL.option_media_backdropcolor = "기본 배경 색상"
	TukuiL.option_media_buttonhover = "커서가 위치했을 때 버튼 텍스쳐"
	TukuiL.option_media_whisper = "귓속말 소리"
	TukuiL.option_media_warning = "경고 소리"
	...
	TukuiL.option_datatext_hps = "초당 치유량 (0은 표시하지 않음)"
	TukuiL.option_datatext_guild = "접속 중인 길드 원의 수 (0은 표시하지 않음)"
	TukuiL.option_datatext_mem = "총 메모리 사용량 (0은 표시하지 않음)"
	TukuiL.option_datatext_bags = "소지품 여유 공간 (0은 표시하지 않음)"
	TukuiL.option_datatext_fontsize = "정보글자 글꼴 크기"
	TukuiL.option_datatext_fps_ms = "프레임율과 지연시간 (0은 표시하지 않음)"
	TukuiL.option_datatext_armor = "방어도 (0은 표시하지 않음)"
	TukuiL.option_datatext_avd = "완방 수치 (0은 표시하지 않음)"
	TukuiL.option_datatext_power = "전투력 또는 주문력 (0은 표시하지 않음)"
	TukuiL.option_datatext_haste = "가속도 (0은 표시하지 않음)"
	TukuiL.option_datatext_friend = "접속 중인 친구의 수 (0은 표시하지 않음)"
	TukuiL.option_datatext_time = "시간 (0은 표시하지 않음)"
	TukuiL.option_datatext_gold = "보유 중인 골드 (0은 표시하지 않음)"
	TukuiL.option_datatext_dps = "초당 피해량 (0은 표시하지 않음)"
	TukuiL.option_datatext_crit = "치명타 및 주문 극대화 적중도 (0은 표시하지 않음)"
	TukuiL.option_datatext_dur = "장비 내구도 (0은 표시하지 않음)"
	TukuiL.option_datatext_currency = "화폐 (0은 표시하지 않음)"
	TukuiL.option_datatext_micromenu = "메뉴 (0은 표시하지 않음)"
	TukuiL.option_datatext_hit = "적중도 (0은 표시하지 않음)"
	TukuiL.option_datatext_mastery = "특화도 (0은 표시하지 않음)"
	...
	TukuiL.option_loot_autogreed = "자동 차비 또는 자동 마력 추출 (녹색 아이템)"
	...
	TukuiL.option_tooltip_showtalent = "특성 표시"
	TukuiL.option_tooltip_talentonlyinparty = "파티나 공격대 중일 때만 특성 표시"
	TukuiL.option_tooltip_showitemlvl = "아이템 레벨 표시"
	...
	TukuiL.option_makeselection = "계속하기 전에 선택해야 합니다."
end