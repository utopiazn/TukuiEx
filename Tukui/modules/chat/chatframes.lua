...
_G.CHAT_BN_WHISPER_INFORM_GET = L.chat_BN_WHISPER_INFORM_GET.." %s:\32"
...
_G.CHAT_WHISPER_INFORM_GET = L.chat_WHISPER_INFORM_GET.." %s:\32"
...
local function SetChatStyle(frame)
	...
	_G[chat]:SetMinResize(C["panels"].infowidth + 1,111)
...
local function SetupChatPosAndFont(self)	
	for i = 1, NUM_CHAT_WINDOWS do
		...
		chat:Size(C["panels"].infowidth + 1, C["chat"].height)
