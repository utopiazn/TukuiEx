...
local FormatTime = function(s)
	...
	if s >= day then
		return format("|cffeeeeee%d"..L.time_day.."|r", ceil(s / day))
	elseif s >= hour then
		return format("|cffeeeeee%d"..L.time_hour.."|r", ceil(s / hour))
	elseif s >= minute then
		return format("|cffeeeeee%d"..L.time_minute.."|r", ceil(s / minute))
...
ScanAuras(CreateAuraHeader("HELPFUL", "TOPRIGHT", -157, -7))
ScanAuras(CreateAuraHeader("HARMFUL", "TOPRIGHT", -157, -143))
