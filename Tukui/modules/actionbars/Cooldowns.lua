...
local MINUTES_FORMAT = T.RGBToHex(1, 1, 1)..'%d'..L.time_minute..'|r' --format for timers that have minutes remaining
local HOURS_FORMAT = T.RGBToHex(0.4, 1, 1)..'%d'..L.time_hour..'|r' --format for timers that have hours remaining
local DAYS_FORMAT = T.RGBToHex(0.4, 0.4, 1)..'%d'..L.time_day..'|r' --format for timers that have days remaining
