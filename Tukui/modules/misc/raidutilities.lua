...
local function CreateUtilities(self, event, addon)
	if addon == "Tukui_Raid_Healing" or addon == "Tukui_Raid" then
		...
		--Disband Raid button
		CreateButton("TukuiRaidUtilityDisbandRaidButton", TukuiRaidUtility, "UIMenuButtonStretchTemplate", TukuiRaidUtility:GetWidth() * 0.95, T.Scale(21), "TOP", TukuiRaidUtility, "TOP", 0, T.Scale(-5), L.raidutil_disband, nil)
