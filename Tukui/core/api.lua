...
local function HighlightUnit(f, v, r, g, b)
	...
	elseif v == "Mouseover" then
		f.HighlightMouseover = CreateFrame("Frame", nil, f)
		f.HighlightMouseover:Point("TOPLEFT", f, "TOPLEFT", -2, 2)
		f.HighlightMouseover:Point("BOTTOMRIGHT", f, "BOTTOMRIGHT", 2, -2)
		f.HighlightMouseover:SetBackdrop(glowBorder)
		f.HighlightMouseover:SetFrameLevel(f:GetFrameLevel() + 1)
		f.HighlightMouseover:Hide()

		f:HookScript("OnEnter", function(f)
			f.HighlightMouseover:Show()
			f.HighlightMouseover:SetBackdropBorderColor(r,g,b,1)
		end)
