...
if not TukuiExSkin or not IsAddOnLoaded("Recount") then return end
local Recount = _G.Recount

TukuiExSkin:RegisterSkin("Recount",function(Skin, skin, Layout, layout, config)	
	...
	function Skin:SkinRecountWindow(window)
	    ...
	    skin:SkinFrame(window.bgMain)
	    window.bgMain:SetPoint("BOTTOMLEFT",window,"BOTTOMLEFT")
	    window.bgMain:SetPoint("BOTTOMRIGHT",window,"BOTTOMRIGHT")
	    window.bgMain:Point("TOP",window,"TOP",0,-30)
	    window.bgMain:SetFrameStrata("LOW")
	    window.bgMain:SetFrameLevel(31)
	    window.bgTitle = CreateFrame("Frame",nil,window)
	    skin:SkinFrame(window.bgTitle)
	    window.bgTitle:Point("TOPRIGHT",window,"TOPRIGHT",0,-10)
	    window.bgTitle:Point("TOPLEFT",window,"TOPLEFT",0,-9)
	    window.bgTitle:Point("BOTTOM",window,"TOP",0,-29)
	    window.bgTitle:SetFrameStrata("LOW")
	    window.bgTitle:SetFrameLevel(31)
	    window.CloseButton:Point("TOPRIGHT",window,"TOPRIGHT",-1,-9)
	    window.Title:Point("TOPLEFT",window,"TOPLEFT",9,-12)
