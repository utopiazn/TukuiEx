...
if not TukuiExSkin or not SexyCooldown then return end
local scd = SexyCooldown
local sc = LibStub("AceLocale-3.0"):GetLocale("SexyCooldown")

TukuiExSkin:RegisterSkin("SexyCooldown",function(Skin,skin,Layout,layout,config)
	...
	function Layout:SCDStripLayoutSettings(bar)
		...
		bar.optionsTable.args.bar.args.orientation.values = {
			LEFT_TO_RIGHT = sc["Left to Right"],
			RIGHT_TO_LEFT = sc["Right to Left"]
		}
